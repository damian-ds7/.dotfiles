...
utils.add(utils.gh "nvim-mini/mini.sessions", function()
  ...
  vim.keymap.set("n", "<leader>qs", restore_session, {
    desc = "Restore Session",
  })

  vim.keymap.set("n", "<leader>ql", function() sessions.select() end, {
    desc = "Select Session",
  })

  vim.keymap.set("n", "<leader>qw", function() sessions.write() end, {
    desc = "Save Session",
  })

  vim.keymap.set("n", "<leader>qd", function() sessions.delete() end, {
    desc = "Delete Session",
  })
