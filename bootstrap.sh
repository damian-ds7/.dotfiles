...
CONFIG_MODULES=(atuin git zsh nvim bat ghostty kitty tmux lsd lazygit themes code yazi opencode kanata)
DRY_RUN=0
RUN_SSH=0
RUN_RESTORE=0
MODULES=()
...
Options:
    ...
    -c, --config       Stow config modules: atuin, git, zsh, nvim, bat, ghostty, kitty, tmux, lsd, lazygit, themes, code, yazi, opencode, kanata
